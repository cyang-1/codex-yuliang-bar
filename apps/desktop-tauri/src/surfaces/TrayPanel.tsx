...
export default function TrayPanel({ state }: { state: BootstrapState }) {
  ...
  const footerRows: MenuFooterRow[] = [
    { icon: "↻", label: "刷新", shortcut: "Ctrl+R", onClick: refresh },
    { icon: "⚙", label: "设置...", shortcut: "Ctrl+,", onClick: openSettings },
    { icon: "ⓘ", label: "关于 Codex 余量条", onClick: openAbout },
    { icon: "⌧", label: "退出", shortcut: "Ctrl+Q", onClick: quitApp },
  ];
