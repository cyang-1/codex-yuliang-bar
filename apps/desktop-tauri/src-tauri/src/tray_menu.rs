...
pub(crate) fn build_tray_menu_with(
    ...
    menu.push(TrayMenuEntry::item("refresh", "\u{5237}\u{65b0}\u{7528}\u{91cf}"));
    menu.push(TrayMenuEntry::item("pop_out", "\u{6253}\u{5f00}\u{4f59}\u{91cf}\u{9762}\u{677f}"));
    menu.push(TrayMenuEntry::item("show_panel", "\u{663e}\u{793a}\u{7a97}\u{53e3}"));
    menu.push(TrayMenuEntry::check_item(
        "toggle_float_bar",
        "\u{663e}\u{793a}\u{4f59}\u{91cf}\u{6761}",
        float_bar_enabled,
    ));
    menu.push(TrayMenuEntry::separator());
    ...
    menu.push(TrayMenuEntry::item("settings", "\u{8bbe}\u{7f6e}"));
    menu.push(TrayMenuEntry::item(
        "check_for_updates",
        "\u{68c0}\u{67e5}\u{66f4}\u{65b0}",
    ));
    menu.push(TrayMenuEntry::item("about", "\u{5173}\u{4e8e}"));
    menu.push(TrayMenuEntry::separator());
    menu.push(TrayMenuEntry::item("quit", "\u{9000}\u{51fa} Codex \u{4f59}\u{91cf}\u{6761}"));
